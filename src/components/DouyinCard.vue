<template>
  <div class="douyin-card" :class="{ selected }" @click="onClick">
    <div class="cover-container">
      <van-image :src="item.cover" fit="cover" width="100%" height="100%" lazy-load>
        <template #loading>
      ...
      <!-- 时长标签/章节标签 -->
      <div v-if="(item.duration && item.content_type !== 'audio') || item.content_type === 'comic' || item.content_type === 'novel' || item.content_type === 'audio'" class="duration-badge">
...
.douyin-card:hover :deep(.van-image__img) {
